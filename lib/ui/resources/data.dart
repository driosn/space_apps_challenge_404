...
List<PlanetInfo> planets = [
  PlanetInfo(1,
      name: 'Mercury',
      iconImage: 'assets/spaceapp/mercury.png',
      description:
  ...
  PlanetInfo(2,
      name: 'Venus',
      iconImage: 'assets/spaceapp/venus.png',
      description:
  ...
  PlanetInfo(3,
      name: 'Earth',
      iconImage: 'assets/spaceapp/earth.png',
      description:
  ...
  PlanetInfo(4,
      name: 'Mars',
      iconImage: 'assets/spaceapp/mars.png',
      description:
  ...
  PlanetInfo(5,
      name: 'Jupiter',
      iconImage: 'assets/spaceapp/jupiter.png',
      description:
  ...
  PlanetInfo(6,
      name: 'Saturn',
      iconImage: 'assets/spaceapp/saturn.png',
      description:
  ...
  PlanetInfo(7,
      name: 'Uranus',
      iconImage: 'assets/spaceapp/uranus.png',
      description:
  ...
  PlanetInfo(8,
      name: 'Neptune',
      iconImage: 'assets/spaceapp/neptune.png',
      description:
